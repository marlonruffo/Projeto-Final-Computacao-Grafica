...
cylinder4.rotateX(80);
cylinder2.add(cylinder4);

var cylinder5 = new THREE.Mesh( cylinderGeometry, cylinderMaterial );
cylinder5.position.set(0,-0.5,0);
cylinder5.rotateX(80);
cylinder2.add(cylinder5);
...
function rotateCylinder()
{
  ...
  if(animationOn)
  {
    ...
    // cylinder4.matrix.multiply(mat4.makeRotationZ(angle3)); // R1
    // cylinder4.matrix.multiply(mat4.makeTranslation(5.0, 5.0, 5.0)); // T1
    // cylinder4.matrix.multiply(mat4.makeRotationZ(degreesToRadians(180))); // R2

    // cylinder5.matrix.multiply(mat4.makeRotationX(angle3)); // R1
    // cylinder5.matrix.multiply(mat4.makeTranslation(0.0, 1.0, 0.0)); // T1
    // cylinder5.matrix.multiply(mat4.makeRotationX(degreesToRadians(-180))); // R2
  }
}
